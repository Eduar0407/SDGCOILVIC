...
public class GestionDeColaboracionesControlador implements Initializable{
    ...
    private void filtrarTabla() {
        ...
        SortedList<TablaColaboracion> sortedData = new SortedList<>(filteredData);
        sortedData.comparatorProperty().bind(tableView_Colaboraciones.comparatorProperty());
        tableView_Colaboraciones.setItems(sortedData);
