...
public class SDGCOILVIC extends Application {
    ...
    public void start(Stage stage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/sdgcoilvic/InterfazDeUsuario/RegistrarInstitucion.fxml"));
    ...
    public void mostrarVentanaAgregarProfesorExterno(Stage stage) throws IOException {
        Stage stageAgregar = new Stage();
    ...
    public void mostrarVentanaAgregarProfesorUV(Stage stage) throws IOException {
        Stage stageAgregar = new Stage();
    ...
    public void mostrarVentanaRegistrarInstitucion(Stage stage) throws IOException {
